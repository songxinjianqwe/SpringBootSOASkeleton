package cn.sinjinsong.skeleton.security.oauth;

import cn.sinjinsong.common.properties.ThirdPartyProperties;
import cn.sinjinsong.skeleton.domain.dto.ThirdPartyUser;
...
public final class ThirdPartyLoginHelper {
    ...
    public ThirdPartyUser loginQQ(String token, String openId){
        return null;
    }
