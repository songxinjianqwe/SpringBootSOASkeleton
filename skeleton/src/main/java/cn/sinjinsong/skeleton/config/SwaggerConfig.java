...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("JavaWeb项目骨架")
                .description("集成了SpringBoot、SpringMVC、Spring、MyBaits、MyBatis Generator、MyBatis PageHelper、Druid、Lombok、JWT、Spring Security、JavaMail、Thymeleaf、HttpClient、FileUpload、Spring Scheduler、Hibernate Validator、Redis、Spring Async、Spring Cache、Swagger、Spring Test、HTTPS(WebSocket、MockMvc、RabbitMQ、)，REST风格的接口的Web项目")
